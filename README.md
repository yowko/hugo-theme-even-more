...
You can visit [my blog](https://www.huanlintalk.com) or Even them's [demo site](https://blog.olowolo.com/example-site/) | [中文说明](https://github.com/olOwOlo/hugo-theme-even/blob/master/README-zh.md)

## Changes in Even-More theme

- [Added Traditional Chinese translation](https://github.com/huanlin/hugo-theme-even-more/blob/master/i18n/zh-TW.yaml)。
- Fixed displaying issue for tag name ".NET" and "C#". See [taxonomy.html](https://github.com/huanlin/hugo-theme-even-more/blob/master/layouts/_default/taxonomy.html#L9-L15)、[terms.html](https://github.com/huanlin/hugo-theme-even-more/blob/master/layouts/_default/terms.html#L35-L44)、[post/single.html](https://github.com/huanlin/hugo-theme-even-more/blob/master/layouts/post/single.html#L52-L61).
- Added Facebook SDK code. So you can simply copy the code generated by [Facebook plugin tools](https://developers.facebook.com/docs/plugins) and paste them to wherever you like.
- Add parameter `showFacebookLikeCount` to Config.toml. If true, a Facebook Like count will be displayed at the end of each post. 
- Chanegd default syntax highlight colors. The Even theme provides 4 styles, and I changed the code syntax colors of default style based on my preference.

The following sections are original content from the Even theme. I didn't touch them.
